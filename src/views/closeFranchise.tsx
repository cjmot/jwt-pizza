        ...
        <View title="Sorry to see you go">
            <div className="text-start py-8 px-4 sm:px-6 lg:px-8">
                <div className="text-neutral-100">
                    ...
                    <span className="text-orange-500">{state.franchise.name}</span> franchise? This
                    will close all associated stores and cannot be restored. All outstanding revenue
